...
const HeroFeature1 = () => {
  return (
    <div className="w-full flex flex-col md:flex-row md:py-6 justify-between items-center">
      <img
        src={features[1].img}
        alt="hero"
        className="w-full mt-[2rem] md:w-2/3 md:h-1/2 md:pl-4"
        loading="lazy"
      />

      <div className="w-full md:w-1/3 flex-row items-center">
        <div className="flex-col mt-[2rem] md:pr-4 md:ml-[-40px]">
