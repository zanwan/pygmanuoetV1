  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col mt-[60px] md:mt-0 md:flex md:flex-row md:py-6 md:justify-between md:items-center">
        ...
        <div className="mt-[1rem] md:mt-[4rem] md:w-5/12 md:flex-row items-center">
          <div className="md:flex-col md:pr-2 md:ml-[6rem] xl:ml-[2rem]">
            <div className=" mx-auto px-4 md:px-0">
              ...
              <div className="font-notoSerifTC text-center md:text-justify text-md tracking-wider leading-6  md:ml-4 text-wrap">
                <img
                  src={subtitleLeft}
                  alt="poemTub-1"
        ...
        <div className="md:w-7/12 md:h-1/2">
          <img
            src={features[0].img}
            alt="hero"
            className="z-0 hidden md:block w-full md:pl-2 md:pr-0 md:mr-0 "
            loading="lazy"
          />
        </div>
      </div>
